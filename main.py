...
if codeTest == 'No':
	targetAuto = 'P:\\Epocrates Analytics\\Code_Library\\Standard_Codes\\Pre Sales\\DocAlert_Python_Reference\\code_repos\\{}\\Targeting Automation Code_OFFICIAL.sas'.format(userRepo)
	targetAutoOrganic = 'P:\\Epocrates Analytics\\Code_Library\\Standard_Codes\\Pre Sales\\DocAlert_Python_Reference\\code_repos\\{}\\Targeting Automation Code_ORGANIC.sas'.format(userRepo)
	targetLillyHibbert = 'P:\\Epocrates Analytics\\Code_Library\\Standard_Codes\\Pre Sales\\DocAlert_Python_Reference\\code_repos\\{}\\Lilly Hibbert Targeting Code.sas'.format(userRepo)
	autoCode = 'P:\\Epocrates Analytics\\Code_Library\\Standard_Codes\\Pre Sales\\DocAlert_Python_Reference\\code_repos\\{}\\Presales Automation.sas'.format(userRepo)
	emailCode = 'P:\\Epocrates Analytics\\Code_Library\\Standard_Codes\\Pre Sales\\DocAlert_Python_Reference\\code_repos\\{}\\Presales Automation_Email_Final.sas'.format(userRepo)
else:
	targetAuto = 'P:\\Epocrates Analytics\\Code_Library\\Standard_Codes\\Pre Sales\\DocAlert_Python_Reference\\code_repos\\{}\\Targeting Automation Code_OFFICIAL.sas'.format(userRepo)
	targetAutoOrganic = 'P:\\Epocrates Analytics\\Code_Library\\Standard_Codes\\Pre Sales\\DocAlert_Python_Reference\\code_repos\\{}\\Targeting Automation Code_ORGANIC.sas'.format(userRepo)
	targetLillyHibbert = 'P:\\Epocrates Analytics\\Code_Library\\Standard_Codes\\Pre Sales\\DocAlert_Python_Reference\\code_repos\\{}\\Lilly Hibbert Targeting Code.sas'.format(userRepo)
...
def buildSDACodes():
	...
	if codeTest == 'No':
		sdaCodeHousing = 'P:\\Epocrates Analytics\\Code_Library\\Standard_Codes\\Pre Sales\\DocAlert_Python_Reference\\code_repos\\{}\\Code Housing\\additionalSDA'.format(userRepo)
	else:
		sdaCodeHousing = 'P:\\Epocrates Analytics\\Code_Library\\Standard_Codes\\Pre Sales\\DocAlert_Python_Reference\\code_repos\\{}\\Code Housing\\additionalSDA'.format(userRepo)
...
def buildBDACodes():
	...
	if buildAddTargets == True:
		bdaCodeHousing = 'P:\\Epocrates Analytics\\Code_Library\\Standard_Codes\\Pre Sales\\DocAlert_Python_Reference\\code_repos\\{}'.format(userRepo)
		bdaCode = 'Targeting Automation Code_OFFICIAL'
		email = ''

	else:
		if codeTest == 'No':
			bdaCodeHousing = 'P:\\Epocrates Analytics\\Code_Library\\Standard_Codes\\Pre Sales\\DocAlert_Python_Reference\\code_repos\\{}\\Code Housing\\additionalBDA'.format(userRepo)
		else:
			bdaCodeHousing = 'P:\\Epocrates Analytics\\Code_Library\\Standard_Codes\\Pre Sales\\DocAlert_Python_Reference\\code_repos\\{}\\Code Housing\\additionalBDA'.format(userRepo)
