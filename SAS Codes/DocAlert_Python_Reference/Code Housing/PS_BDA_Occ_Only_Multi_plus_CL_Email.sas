...
title j=left font = Calibri height=11Pt color=blumine;
title "
^{style [Font_weight=bold FONT=(Calibri,11Pt) color=#1f4e79] **} ^{style [FONT=(Calibri,11Pt) color=#1f4e79] Remaining campaign eligible &bda_occ_nocom who have looked up Drugs &drugs &lookups_GE + Times in the past &bda_lookback_period days}
"
;
