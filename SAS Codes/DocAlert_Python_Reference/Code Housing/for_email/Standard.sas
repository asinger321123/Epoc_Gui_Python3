************************************************************************************************
* CODE NAME: PS_NPI_ME_3PT                                                                     *
* AUTHOR: Adam Rubin                                                                           *
* CREATION DATE: 20170109                                                                      *
* MACRO VERSION: 1.0                                                                           *
* PURPOSE: Price Client List by NPI or ME or 3PT                                               *
*                                                                                              *
* REVISIONS:                                                                                   *
...
/* three options: 1)pipe--columns are separated by '|' ; 
	...
	%let file_type = tab;
	%let keepvars= fname lname npi zip me;
...
/*proc sql;*/
/*alter table target*/
/*add epoc_me2 Select Case when name = 'me' and type = 2 then 'Char(50)' end from target_import_values;*/
/*quit;*/

/*, epoc_npi numeric, epoc_fname char(50), epoc_lname char(50), epoc_zip char(50)*/

/*proc sql;*/
/*update target*/
/*set epoc_me=me, epoc_npi=npi, epoc_fname=fname, epoc_lname=lname, epoc_zip=zip;*/
/*quit;*/

proc sql;
  select count(*) as Target_List_Count into :fcount from (select distinct npi, lname, fname, me, zip from target);
quit;
...
/*	where last_session_dt GE today()-197;*/
/*quit;*/
