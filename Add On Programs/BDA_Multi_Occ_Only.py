...
copyfile(bdaCode, os.path.join(listMatchFolder, 'PS_BDA_Occ_Only_Multi_plus_CL_Email.sas'))
newInput = os.path.join(listMatchFolder, 'PS_BDA_Occ_Only_Multi_plus_CL_Email.sas')
